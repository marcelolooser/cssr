...
if save_frames_heaviside:
    if set_frames_heaviside and set_frames_heaviside_overcomplete:
    ...
    elif set_frames_heaviside and not set_frames_heaviside_overcomplete:
        np.savez(dir_frames + "heaviside",
                 x = x,
                 bw_heaviside = bw_heaviside,
                 a0_heaviside1 = a0_heaviside1,
    ...
    elif not set_frames_heaviside and set_frames_heaviside_overcomplete:
        np.savez(dir_frames + "heaviside",
                 x = x,
                 bw_heaviside_overcomplete = np.array(bw_heaviside_overcomplete, dtype=float),
                 ss_heaviside_overcomplete = np.array(ss_heaviside_overcomplete, dtype=float),
...
if save_frames_gaussian:
    if set_frames_gaussian and set_frames_gaussian_overcomplete:
    ...
    elif set_frames_gaussian and not set_frames_gaussian_overcomplete:
        np.savez(dir_frames + "gaussian",
                 x = x,
                 bw_gaussian = bw_gaussian,
                 a0_gaussian1 = a0_gaussian1,
    ...
    elif not set_frames_gaussian and set_frames_gaussian_overcomplete:
        np.savez(dir_frames + "gaussian",
                 x = x,
                 bw_gaussian_overcomplete = np.array(bw_gaussian_overcomplete, dtype=float),
                 ss_gaussian_overcomplete = np.array(ss_gaussian_overcomplete, dtype=float),
...
if save_frames_cauchy:
    if set_frames_cauchy and set_frames_cauchy_overcomplete:
    ...
    elif set_frames_cauchy and not set_frames_cauchy_overcomplete:
        np.savez(dir_frames + "cauchy",
                 x = x,
                 bw_cauchy = bw_cauchy,
                 a0_cauchy1 = a0_cauchy1,
    ...
    elif not set_frames_cauchy and set_frames_cauchy_overcomplete:
        np.savez(dir_frames + "cauchy",
                 x = x,
                 bw_cauchy_overcomplete = np.array(bw_cauchy_overcomplete, dtype=float),
                 ss_cauchy_overcomplete = np.array(ss_cauchy_overcomplete, dtype=float),
